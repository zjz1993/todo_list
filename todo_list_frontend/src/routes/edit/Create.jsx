...
import {putTask, viewTask} from "../../service/indexApi";
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      if (!err) {
        ...
        putTask(values).then((data) => {
          Modal.success({content: '修改事件成功！'});
          console.log(data);
        });
      }
    });
